...
var functionUncurryThis = bind$7
  ? function (fn) {
...
var getBuiltIn$9 = function (namespace, method) {
  return arguments.length < 2
    ? aFunction(path$7[namespace]) || aFunction(global$D[namespace])
    : (path$7[namespace] && path$7[namespace][method]) ||
...
var isSymbol$2 = USE_SYMBOL_AS_UID$1
  ...
  : function (it) {
      ...
      return (
        isCallable$e($Symbol) &&
        isPrototypeOf$8($Symbol.prototype, Object$5(it))
      );
    };
...
var ordinaryToPrimitive$1 = function (input, pref) {
  ...
  if (
    ...
    !isObject$a((val = call$9(fn, input)))
  )
    return val;
  if (
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$6
  ...
  : function getOwnPropertyDescriptor(O, P) {
      ...
      if (hasOwn$9(O, P))
        return createPropertyDescriptor$5(
...
var _export = function (options, source) {
  ...
  var nativeSource = GLOBAL
    ...
    : STATIC
    ? global$p[TARGET]
    : (global$p[TARGET] || {}).prototype;

  var target = GLOBAL
    ? path$6
    : path$6[TARGET] ||
      createNonEnumerableProperty$6(path$6, TARGET, {})[TARGET];
  ...
  for (key in source) {
    ...
    if (options.bind && USE_NATIVE)
      resultProperty = bind$5(sourceProperty, global$p);
    // wrap global constructors for prevent changs in this version
    else if (options.wrap && USE_NATIVE)
      resultProperty = wrapConstructor(sourceProperty);
    // make static versions for prototype methods
    else if (PROTO && isCallable$a(sourceProperty))
      resultProperty = uncurryThis$e(sourceProperty);
    // default case
...
var objectKeysInternal = function (object, names) {
  ...
  var key;
  for (key in O)
    !hasOwn$6(hiddenKeys$3, key) && hasOwn$6(O, key) && push$2(result, key);
...
var ownKeys$1 =
  ...
  function ownKeys(it) {
    ...
    return getOwnPropertySymbols
      ? concat$5(keys, getOwnPropertySymbols(it))
      : keys;
  };
...
var isArrayIteratorMethod$1 = function (it) {
  return (
    it !== undefined &&
    (Iterators$5.Array === it || ArrayPrototype$5[ITERATOR$5] === it)
  );
};
...
var classof$9 = TO_STRING_TAG_SUPPORT$2
  ...
  : function (it) {
      ...
      return it === undefined
        ...
        (result = classofRaw(O)) == "Object" && isCallable$7(O.callee)
        ? "Arguments"
        : result;
    };
...
var iterate$4 = function (iterable, unboundFunction, options) {
  ...
  if (IS_ITERATOR) {
    ...
    if (!iterFn)
      throw TypeError$7(tryToString$1(iterable) + " is not iterable");
  ...
  while (!(step = call$4(next, iterator)).done) {
    ...
    if (
      ...
      result &&
      isPrototypeOf$7(ResultPrototype, result)
    )
      return result;
  }
  return new Result(false);
...
var $AggregateError = function AggregateError(errors, message /* , options */) {
  ...
  if (setPrototypeOf) {
    that = setPrototypeOf(
      new Error$1(undefined),
      isInstance ? getPrototypeOf$2(this) : AggregateErrorPrototype
    );
  } else {
...
var AggregateErrorPrototype = ($AggregateError.prototype = create$2(
  Error$1.prototype,
  {
...
var nativeWeakMap =
  isCallable$5(WeakMap$1) && /native code/.test(inspectSource$2(WeakMap$1));
...
var speciesConstructor$2 = function (O, defaultConstructor) {
  ...
  var S;
  return C === undefined || (S = anObject$1(C)[SPECIES$3]) == undefined
    ? defaultConstructor
    : aConstructor(S);
};
...
var dispatchEvent = function (name, promise, reason) {
  ...
  if (!NATIVE_REJECTION_EVENT && (handler = global$7["on" + name]))
    handler(event);
...
$$e(
  { target: PROMISE, stat: true, forced: IS_PURE },
  {
...
var defineProperty$3 = (defineProperty$4.exports = function defineProperty(
  it,
  key,
  desc
) {
...
// eslint-disable-next-line es/no-array-prototype-foreach -- safe
$$8(
  { target: "Array", proto: true, forced: [].forEach != forEach$5 },
  {
    forEach: forEach$5,
  }
);
...
var forEach$2 = function (it) {
  ...
  return it === ArrayPrototype$4 ||
    (isPrototypeOf$4(ArrayPrototype$4, it) &&
      own === ArrayPrototype$4.forEach) ||
      ...
      for (i = -1, length = arguments.length; i < length; i++) {
        ...
        if (isConcatSpreadable(E)) {
          ...
          if (n + len > MAX_SAFE_INTEGER)
            throw TypeError$2(MAXIMUM_ALLOWED_INDEX_EXCEEDED);
...
var concat$3 = function (it) {
  ...
  return it === ArrayPrototype$3 ||
    (isPrototypeOf$3(ArrayPrototype$3, it) && own === ArrayPrototype$3.concat)
    ? method$2
    : own;
};
...
var includes$3 = function (it) {
  ...
  if (
    it === ArrayPrototype$2 ||
    (isPrototypeOf$2(ArrayPrototype$2, it) && own === ArrayPrototype$2.includes)
  )
    return arrayMethod;
  if (
    typeof it == "string" ||
    it === StringPrototype ||
    (isPrototypeOf$2(StringPrototype, it) && own === StringPrototype.includes)
  ) {
    return stringMethod;
  }
  return own;
...
var map$3 = function (it) {
  ...
  return it === ArrayPrototype$1 ||
    (isPrototypeOf$1(ArrayPrototype$1, it) && own === ArrayPrototype$1.map)
    ? method$1
    : own;
};
...
var fill$3 = function (it) {
  ...
  return it === ArrayPrototype ||
    (isPrototypeOf(ArrayPrototype, it) && own === ArrayPrototype.fill)
    ? method
    : own;
};
...
var Log = /*#__PURE__*/ (function () {
  ...
  function Log() {
    ...
    _defineProperty(this, "rcsoutput", null);
  }
  /**
   * log级别
   * @param {*} message 输出信息
...
var TinyPng = /*#__PURE__*/ (function () {
   ...
   */
  function TinyPng(entry, deep, progress, rcsoutput) {
    var _context,
      _this = this;
    ...
    forEach((_context = keys(this.config))).call(_context, function (key) {
      if (key !== "files") {
        ...
        Tlog.log(
          concat((_context2 = "\u914D\u7F6E".concat(key, "\uFF1A"))).call(
            _context2,
            _this.config[key]
          )
        );
  ...
  _createClass(TinyPng, [
                ...
                while (1) {
                  switch ((_context4.prev = _context4.next)) {
                    ...
                    case 2:
                      ...
                      forEach((_context3 = this.config.files)).call(
                        _context3,
                        function (img) {
    ...
    },
    {
      ...
      value: function fileFilter(folder) {
        ...
        // 读取文件夹
        forEach((_context5 = fs__default["default"].readdirSync(folder))).call(
          _context5,
          function (file) {
            var _context6;
            ...
            if (
              fileStat.size <= _this3.config.max &&
              fileStat.size >= _this3.config.min &&
              fileStat.isFile() &&
              includes((_context6 = _this3.config.extension)).call(
                _context6,
      ...
      value: function getAjaxOptions() {
        ...
        return {
          ...
          headers: {
            ...
            "X-Forwarded-For": map(
              (_context7 = fill((_context8 = Array(4))).call(_context8, 1))
            )
              .call(_context7, function () {
      ...
      value: function fileUpload(imgPath) {
        ...
        return new promise(function (resolve, reject) {
          ...
          var process = function process() {
            var req = https__default["default"].request(
              _this4.getAjaxOptions(),
              function (res) {
                res.on(
                  "data",
                  /*#__PURE__*/ (function () {
                    var _ref = _asyncToGenerator(
                      /*#__PURE__*/ regenerator.mark(function _callee2(buf) {
                        var obj, _context9;
                    ...
                    function (err) {
                      if (err) {
                        ...
                        var message = concat(
                          (_context12 = concat(
                            (_context13 = concat(
                              ...
                              _context14,
                              (obj.input.size / 1024).toFixed(2),
                              "KB \uFF0C\u538B\u7F29\u5927\u5C0F: "
                            ))
                          ).call(
                            _context13,
                            (obj.output.size / 1024).toFixed(2),
                            "KB \uFF0C\u6587\u4EF6\uFF1A"
                          ))
                        ).call(_context12, entryImgPath);
                        ...
                        Tlog.success({
                          ...
                          ).call(_context15, _this5.config.files.length),
                        });
                        resolve(message);
                      }
                    }
